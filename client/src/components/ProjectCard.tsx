      ...
      <div className="bd-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-white/20 transition group">
        ...
        >
          ...
          <div className="absolute left-3 top-3 flex gap-3 items-center">
            ...
            {gen.isPublished && (
              <span className="text-xs px-2 py-1 bg-green-600/30 rounded-full text-green-300">
                Published
              </span>
            )}
          </div>
          ...
          {!forCommunity && (
            ...
            >
              ...
              <div className="flex flex-col items-end w-32 text-sm">
                <ul
                  className={`text-xs ${menuOpen ? "block" : "hidden"} overflow-hidden right-0 peer-focus:block hover:block w-40 bg-black/50 backdrop-blur text-white border border-gray-500/50 rounded-lg shadow-md mt-2 z-10 py-1`}
                >
                  {gen.generatedImage && (
                    <a
                      href="#"
          ...
          <div className="absolute right-3 v-3 bottom-3">
            <img
              ...
              alt="product"
              className="w-16 h016 object-cover rounded-full animate-float"
            />
            <img
              src={gen.uploadedImages[1]}
              alt="model"
              className="w-16 h016 object-cover rounded-full animate-float -ml-8"
          ...
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="text-right">
              <div className="mt-2 flex flex-col items-end gap-1">
                <span className="test-xs px-2 py-1 bg-white/5 rounded-full">
