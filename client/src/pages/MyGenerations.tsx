  ...
  return loading?(
    <div className="flex items-center justify-center h-screen">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* generation list */}
        <div className="columns-1 md:columns-2 lg:columns-3 gap-4 pt-12">
          {generations.map((gen)=> (
            // <div key={project.id}>{project.productName}</div>
            <ProjectCard
              key={gen.id}
              gen={gen}
        ...
        {generations.length === 0 && (
          <div className="text-center py-20 bg-white/5 rounded-xl broder border-white/10">
